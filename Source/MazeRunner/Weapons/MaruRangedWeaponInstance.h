...
#include "MaruRangedWeaponInstance.generated.h"

class UPhysicalMaterial;

/**
 * UMaruRangedWeaponInstance
 *
 * A piece of equipment representing a ranged weapon spawned and applied to a pawn
 */
UCLASS()
class UMaruRangedWeaponInstance : public UMaruWeaponInstance, public IMRAbilitySourceInterface
{
	GENERATED_BODY()

public:
	UMaruRangedWeaponInstance(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
...
protected:
	...
	// Speeds at or below this are considered standing still急停门槛
...
public:
	...
	//~IMRAbilitySourceInterface interface
	...
	//~End of IMRAbilitySourceInterface interface

...
#include "OriginalSample/MazeRunnerCharacter.h"
#include "OriginalSample/Variant_Shooter/Weapons/ShooterWeaponHolder.h"
 ...
 */
UCLASS(abstract)
class MAZERUNNER_API AShooterNPC : public AMazeRunnerCharacter, public IShooterWeaponHolder
{
	GENERATED_BODY()

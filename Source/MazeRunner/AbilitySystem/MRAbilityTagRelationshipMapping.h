...
#include "MRAbilityTagRelationshipMapping.generated.h"

class UObject;

/** Struct that defines the relationship between different ability tags */
//和EMRAbilityActivationGroup的关系是什么？
USTRUCT()
struct FMRAbilityTagRelationship
{
	GENERATED_BODY()
...
//挂载在PawnData中，被ASC所获取
UCLASS()
class UMRAbilityTagRelationshipMapping : public UDataAsset
{
	GENERATED_BODY()
...
private:
	...
	TArray<FMRAbilityTagRelationship> AbilityTagRelationships;

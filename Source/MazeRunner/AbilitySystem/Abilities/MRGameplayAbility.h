...
class UAnimMontage;
class UMRAbilityCost;
class UMRAbilitySystemComponent;
//class ULyraCameraMode;
class UMRHeroComponent;
class UObject;
struct FFrame;
...
class UMRGameplayAbility : public UGameplayAbility
{
	GENERATED_BODY()
	friend class UMRAbilitySystemComponent;

public:

	 UMRGameplayAbility(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());

	UFUNCTION(BlueprintCallable, Category = "MazeRunner|Ability")
	 UMRAbilitySystemComponent* GetMRAbilitySystemComponentFromActorInfo() const;

	UFUNCTION(BlueprintCallable, Category = "MazeRunner|Ability")
	 AMRPlayerController* GetMRPlayerControllerFromActorInfo() const;

	UFUNCTION(BlueprintCallable, Category = "MazeRunner|Ability")
	 AController* GetControllerFromActorInfo() const;

	UFUNCTION(BlueprintCallable, Category = "MazeRunner|Ability")
	 AMRCharacter* GetMRCharacterFromActorInfo() const;

	UFUNCTION(BlueprintCallable, Category = "Lyra|Ability")
	 UMRHeroComponent* GetHeroComponentFromActorInfo() const;
...
protected:
	...
	//~End of UGameplayAbility interface
	 ...
	 virtual void GetAbilitySource(FGameplayAbilitySpecHandle Handle, const FGameplayAbilityActorInfo* ActorInfo, float& OutSourceLevel, const IMRAbilitySourceInterface*& OutAbilitySource, AActor*& OutEffectCauser) const;
...
protected:
	...
	TArray<TObjectPtr<UMRAbilityCost>> AdditionalCosts;

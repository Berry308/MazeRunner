...
class UWorld;
struct FFrame;
struct FSwapAudioOutputResult;//音频输出变化结果

/**
 * UMRLocalPlayer
 */
UCLASS(MinimalAPI)
class UMRLocalPlayer : public ULocalPlayer/*, public ILyraTeamAgentInterface*/
{
	GENERATED_BODY()
...
private:
	...
	UPROPERTY()
	TWeakObjectPtr<APlayerController> LastBoundPC;//上一个绑定的PlayerController
};

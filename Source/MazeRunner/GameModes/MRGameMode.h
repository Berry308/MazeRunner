 ...
 */
DECLARE_MULTICAST_DELEGATE_TwoParams(FOnMRGameModePlayerInitialized, AGameModeBase* /*GameMode*/, AController* /*NewPlayer*/);
...
class AMRGameMode : public AModularGameModeBase
{
	GENERATED_BODY()

public:

	AMRGameMode(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());

	UFUNCTION(BlueprintCallable, Category = "Lyra|Pawn")
	const UMRPawnData* GetPawnDataForController(const AController* InController) const;
	...
	FOnMRGameModePlayerInitialized OnGameModePlayerInitialized;

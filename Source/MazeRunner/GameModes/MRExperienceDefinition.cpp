...
#include UE_INLINE_GENERATED_CPP_BY_NAME(MRExperienceDefinition)

#define LOCTEXT_NAMESPACE "LyraSystem"

UMRExperienceDefinition::UMRExperienceDefinition()
{
}

#if WITH_EDITOR
EDataValidationResult UMRExperienceDefinition::IsDataValid(FDataValidationContext& Context) const
{
...
void UMRExperienceDefinition::UpdateAssetBundleData()
{
